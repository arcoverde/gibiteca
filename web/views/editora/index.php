...
<div class="editora-index">
    ...
    <?php yii\widgets\Pjax::begin(['id' => 'editora-grid-pjax']) ?>
    <?= GridView::widget([
            ...
            [
                ...
                'buttons' => [
                    'update' => function($url, $model, $key) {
                        return '<a href="" class="updateData" id="' . $model->id_editora . '" title="Alterar"><span class="glyphicon glyphicon-pencil"></span></a>';
                    },
                ],
            ],
        ],
        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <span><strong><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> <em>Editora</em></strong></span>
                </div>        
...
$this->registerJs("$('.updateData').on('click', function(event) {
        ...
        $.ajax({
            type: 'GET',
            url: '" . yii\helpers\Url::to(['editora/update']) . "',
            data: {id: id},
...
$this->registerJs("$('.createData').on('click', function(event) {
        ...
        $.ajax({
            type: 'GET',
            url: '" . yii\helpers\Url::to(['editora/create']) . "',
            success: function(data)
            {
                $('#modal_window_body').html(data);
                $('#modal_window').modal();
